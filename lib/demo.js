...
// main function
  ...
  async getClosableIssues(){
    ...
    this.logger.info('will close issues updated earlier than '+ labeledEarlierThan + ' under repository ' +  repo)
  ...
  async getrequiredIssues () {
    ...
    this.logger.info('will add label to issues updated earlier than '+UpdatedEarlierThan + ' under repository ' +  repo)
